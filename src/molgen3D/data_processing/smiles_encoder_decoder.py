...
def normalize_serialization_tag(tag: Optional[str], default: str = "cartesian") -> str:
    aliases = {
        "cartesian": "cartesian",
        "uniform": "uniform",
        "quantile": "quantile",
    ...
    if not tag:
        return default
    return aliases.get(tag.strip().lower(), default)
...
def decode_conformer_by_serialization(
    ...
    *,
    ...
    mode = normalize_serialization_tag(serialization_tag)
    if mode == "cartesian":
